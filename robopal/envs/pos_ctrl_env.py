...
class PosCtrlEnv(SingleArmEnv):
    def __init__(self,
        ...
        _, r_init_m = self.kdl_solver.getEeCurrentPose(self.robot.single_arm.arm_qpos)
    ...
    def step(self, action):
        ...
        if self.is_pd is False:
            ...
            p_cur, r_cur_m = self.kdl_solver.getEeCurrentPose(self.robot.single_arm.arm_qpos)
        ...
        action = self.kdl_solver.ikSolver(p_goal, r_goal, q_init=self.robot.single_arm.arm_qpos)
